...
def main():
    ...
    active_obj = None
    pen_button = Button(20, 20, "paint/images/pen.png")
    rect_button = Button(70, 20, "paint/images/rect.png")
    circle_button = Button(120, 20, "paint/images/circle.png")
    eraser_button = Button(400, 20, "paint/images/eraser.png")
    triangle_button = Button(170, 20, "paint/images/triangle.png")
    equilateralTriangle_button = Button(220, 20, "paint/images/triangle2.png")
    romb_button = Button(270, 20, "paint/images/romb.png")
